  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50" onClick={onClose}>
      <div className="bg-white rounded-2xl p-6 w-full max-w-sm mx-4 shadow-2xl border border-gray-100" onClick={e => e.stopPropagation()}>
        ...
        {sent ? (
          ...
          <>
            <button
              ...
              className="w-full flex items-center justify-center gap-3 border border-gray-300 rounded-xl py-3 mb-4 hover:bg-gray-50 font-medium text-gray-700 transition-colors"
            >
        ...
        <button onClick={onClose} className="mt-4 w-full text-gray-400 text-sm hover:text-gray-600 transition-colors py-1">
          Cancel
        </button>
      </div>
    </div>
